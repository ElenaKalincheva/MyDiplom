...
- ОР - оплата тура не прошла, появилось сообщение о б ошибке.Запись в базу данных в таблицу со статусом DECLINED.
...
3.9. Заполнение поля срок действия буквами
...
3.10. Заполнение поля срок действия спец символами(например +++)
- ввести в поле срок действия +++
- остальные поля заполнить валидными данными 
- нажать оправить
- ОР - поле срок действия подчеркивается красным цветом, появляется сообщение об ошибке,отправка формы не происходит

3.11. Заполнение поля срок действия пробелами
- ввести в поле срок действия пробелы
- остальные поля заполнить валидными данными 
- нажать оправить
- ОР - поле срок действия подчеркивается красным цветом, появляется сообщение об ошибке,отправка формы не происходит

3.12. Заполнение поля Владелец цифрами
...
3.13. Заполнение поля Владелец кириллицей
- ввести в поле владелец фамилию и имя кириллицей
- остальные поля заполнить валидными данными 
- нажать оправить
- ОР - поле владелец подчеркивается красным цветом, появляется сообщение об ошибке,отправка формы не происходит

3.14. Заполнение поля Владелец пробелами
- ввести в поле владелец пробелы
- остальные поля заполнить валидными данными 
- нажать оправить
- ОР - поле владелец подчеркивается красным цветом, появляется сообщение об ошибке,отправка формы не происходит

3.15. Заполнение поля Владелец спец символами (например ***)
- ввести в поле владелец ***
- остальные поля заполнить валидными данными 
- нажать оправить
- ОР - поле владелец подчеркивается красным цветом, появляется сообщение об ошибке,отправка формы не происходит

3.16. Заполнение поля CVC/CVV буквами
...
3.17. Заполнение поля CVC/CVV спец символами (например +++)
- ввести в поле CVC/CVV +++
- остальные поля заполнить валидными данными 
- нажать оправить
- ОР - поле CVC/CVV подчеркивается красным цветом, появляется сообщение об ошибке,отправка формы не происходит

3.18. Заполнение поля CVC/CVV пробелами
